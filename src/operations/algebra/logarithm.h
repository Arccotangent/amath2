...
#ifndef AMATH2_LOGARITHM_H
#define AMATH2_LOGARITHM_H
...
private:
	...
	explicit Logarithm(std::vector<GiNaC::ex>);

public:
	static Logarithm &getInstance(std::vector<GiNaC::ex>);
