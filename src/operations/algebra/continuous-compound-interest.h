...
#ifndef AMATH2_CONTINUOUS_COMPOUND_INTEREST_H
#define AMATH2_CONTINUOUS_COMPOUND_INTEREST_H


#include <vector>
#include <ginac/ginac.h>

class ContinuousCompoundInterest {
private:
...
#endif //AMATH2_CONTINUOUS_COMPOUND_INTEREST_H
