...
#ifndef AMATH2_BINARY_LOGARITHM_H
#define AMATH2_BINARY_LOGARITHM_H
...
private:
	...
	explicit BinaryLogarithm(std::vector<GiNaC::ex>);

public:
	static BinaryLogarithm &getInstance(std::vector<GiNaC::ex>);
...
#endif //AMATH2_BINARY_LOGARITHM_H
