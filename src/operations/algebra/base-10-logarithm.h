...
#ifndef AMATH2_BASE_10_LOGARITHM_H
#define AMATH2_BASE_10_LOGARITHM_H
...
private:
	...
	explicit Base10Logarithm(std::vector<GiNaC::ex>);

public:
	static Base10Logarithm &getInstance(std::vector<GiNaC::ex>);
...
#endif //AMATH2_BASE_10_LOGARITHM_H
