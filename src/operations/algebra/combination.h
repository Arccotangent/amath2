...
#ifndef AMATH2_COMBINATION_H
#define AMATH2_COMBINATION_H
...
private:
	...
	explicit Combination(std::vector<GiNaC::ex> args);

public:
	static Combination &getInstance(std::vector<GiNaC::ex> args);
