...
#ifndef AMATH2_COMPOUND_INTEREST_H
#define AMATH2_COMPOUND_INTEREST_H
...
private:
	...
	explicit CompoundInterest(std::vector<GiNaC::ex>);

public:
	static CompoundInterest &getInstance(std::vector<GiNaC::ex>);
...
#endif //AMATH2_COMPOUND_INTEREST_H
