...
#ifndef AMATH2_CUSTOM_BASE_LOGARITHM_H
#define AMATH2_CUSTOM_BASE_LOGARITHM_H
...
private:
	...
	explicit CustomBaseLogarithm(std::vector<GiNaC::ex>);

public:
	static CustomBaseLogarithm &getInstance(std::vector<GiNaC::ex>);
...
#endif //AMATH2_CUSTOM_BASE_LOGARITHM_H
