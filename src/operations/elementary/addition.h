...
#ifndef AMATH2_ADDITION_H
#define AMATH2_ADDITION_H
...
private:
	...
	explicit Addition(std::vector<GiNaC::ex>);
public:
	static Addition &getInstance(std::vector<GiNaC::ex>);
