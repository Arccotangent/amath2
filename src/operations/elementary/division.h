...
*/
#ifndef AMATH2_DIVISION_H
#define AMATH2_DIVISION_H
...
private:
	...
	explicit Division(std::vector<GiNaC::ex>);
public:
	static Division &getInstance(std::vector<GiNaC::ex>);
