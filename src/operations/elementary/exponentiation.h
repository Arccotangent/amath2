...
#ifndef AMATH2_EXPONENTIATION_H
#define AMATH2_EXPONENTIATION_H
...
private:
	...
	explicit Exponentiation(std::vector<GiNaC::ex>);
public:
	static Exponentiation &getInstance(std::vector<GiNaC::ex>);
