...
#ifndef AMATH2_SUBTRACTION_H
#define AMATH2_SUBTRACTION_H
...
private:
	...
	explicit Subtraction(std::vector<GiNaC::ex>);
public:
	static Subtraction &getInstance(std::vector<GiNaC::ex>);
