...
#ifndef AMATH2_MULTIPLICATION_H
#define AMATH2_MULTIPLICATION_H
...
private:
	...
	explicit Multiplication(std::vector<GiNaC::ex>);
public:
	static Multiplication &getInstance(std::vector<GiNaC::ex>);
